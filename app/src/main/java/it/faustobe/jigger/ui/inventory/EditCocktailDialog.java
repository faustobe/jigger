...
public class EditCocktailDialog extends DialogFragment {

    private static final String ARG_COCKTAIL_ID = "cocktail_id";
    private static final String ARG_COCKTAIL_NAME = "cocktail_name";
    private static final String ARG_COCKTAIL_CATEGORY = "cocktail_category";
    private static final String ARG_COCKTAIL_GLASS = "cocktail_glass";
    private static final String ARG_COCKTAIL_FAVORITE = "cocktail_favorite";
    ...
    private OnCocktailUpdatedListener listener;

    public interface OnCocktailUpdatedListener {
        void onCocktailUpdated(Cocktail cocktail);
    }

    public static EditCocktailDialog newInstance(Cocktail cocktail) {
        EditCocktailDialog dialog = new EditCocktailDialog();
        Bundle args = new Bundle();
        args.putString(ARG_COCKTAIL_ID, cocktail.getId());
        args.putString(ARG_COCKTAIL_NAME, cocktail.getName());
        args.putString(ARG_COCKTAIL_CATEGORY, cocktail.getCategory());
        args.putString(ARG_COCKTAIL_GLASS, cocktail.getGlassType());
        args.putBoolean(ARG_COCKTAIL_FAVORITE, cocktail.isFavorite());
        dialog.setArguments(args);
        return dialog;
    }

    public void setOnCocktailUpdatedListener(OnCocktailUpdatedListener listener) {
    ...
    public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
        ...
        // Load cocktail data from arguments
        Bundle args = getArguments();
        if (args != null) {
            cocktailId = args.getString(ARG_COCKTAIL_ID);
            nameEditText.setText(args.getString(ARG_COCKTAIL_NAME));
            categoryDropdown.setText(args.getString(ARG_COCKTAIL_CATEGORY), false);
            glassDropdown.setText(args.getString(ARG_COCKTAIL_GLASS), false);
            isFavorite = args.getBoolean(ARG_COCKTAIL_FAVORITE);
        }
    ...
    private void validateAndSave() {
        ...
        if (listener != null) {
            listener.onCocktailUpdated(cocktail);
        }
